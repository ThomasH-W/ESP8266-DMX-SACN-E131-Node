...
<tr>
	...
	<td><input type="text" id="devicename" name="devicename" value="" pattern="[a-zA-Z0-9\-]*"></td>
</tr>
...
<tr><td colspan="2" align="center"><input type="submit" name="reset" style="width:150px" class="btn btn--m btn--blue" value="FACTORY DEFAULTS"></td></tr>
</table>
</form>
<script>
